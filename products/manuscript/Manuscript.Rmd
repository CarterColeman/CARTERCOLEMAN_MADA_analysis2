...
Table \@ref(tab:hesitancesummarytable) shows a hesitance and CVAC table.

```{r hesitancesummarytable,  echo=FALSE}
hesitancesummarytable=readRDS("../../results/hesitancesummarytable.rds")
knitr::kable(hesitancesummarytable, caption = 'Hesitance and CVAC Table')
```


Figure \@ref(fig:figure1) shows a scatterplot for the estimate hesitant of getting the vaccine with Social Vulnerability index.

```{r figure1,  fig.cap='Analysis figure.', echo=FALSE}
knitr::include_graphics("../../results/figure1.png")
```

Figure \@ref(fig:figure2) shows a scatterplot for Vaccinated adults and hesitance for each county in Georgia showing an outlier county.

```{r figure2,  fig.cap='Analysis figure.', echo=FALSE}
knitr::include_graphics("../../results/figure2.png")
```

Figure \@ref(fig:figure3) shows a scatterplot for Vaccinated adults and hesitance for each county in Georgia without the outlier.

```{r figure3,  fig.cap='Analysis figure.', echo=FALSE}
knitr::include_graphics("../../results/figure3.png")
```

Figure \@ref(fig:figure4) shows a Boxplot of hesitance for each CVAC level.
